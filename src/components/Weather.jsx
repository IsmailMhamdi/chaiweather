...
export default function Weather() {
    ...
    return(
        ...
        <div className="col-xl-6 pb-4 pt-2 h-auto m-auto text-center container mt-4 rounded-3 bg-info ">
           <img src={logo_icon} alt="" width={'120px'} className="" />
            ...
            <input type="text" placeholder="Search" className="d-flex focus-ring fs-5 bold cityInput  bg-light text-secondary py-2 ps-3 w-50 border-0 rounded-4" />
                <div className="search-icon" style={{cursor:'pointer'}} onClick={ ()=>{search()}}>
            ...
            <div className="d-flex justify-content-center temp text-dark fs-1 fw-bold">
                24°C
            </div>
            <div className="d-flex justify-content-center text-dark fs-3 fw-bold location">London</div>
